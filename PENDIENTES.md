...
| **3b** | ⬜ **Pendiente de la Fase 3**: pasar `orgId` a las vistas que hoy usan la predeterminada (Dataroom, Índice ESG, Diagnóstico, notificaciones). Mientras no se haga, cambiar de organización en el selector recarga pero esas vistas siguen mostrando la predeterminada | Medio |
